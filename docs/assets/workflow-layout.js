...
window.GUIDE_WORKFLOW_LAYOUT = {
  ...
  "background-check": [
    { title: "신원조사", blocks: ["p21-b1","p21-b2","p21-b3","p21-b4","p21-b5","p21-b6"] },
    { title: "결격사유 조회", blocks: ["p21-b7","p21-b8","p21-b9"] },
    { title: "성범죄 경력 및 아동학대관련 범죄전력조회", blocks: ["p22-b1","p22-b2","p22-b3"] },
    { title: "행정정보 공동이용 시스템 이용 절차", blocks: ["p23-b1","p23-b2","p23-b3","p23-b4","p23-b5"] }
  ],
  "cyber-security-day": [
    { title: "사이버 보안진단의 날 운영", blocks: ["p24-b1","p24-b2","p24-b3","p24-b4","p24-b5","p24-b6","p24-b7","p24-b8"] },
    { title: "보안감사", blocks: ["p24-b9","p24-b10","p24-b11","p24-b12","p24-b13"] }
  ],
  "facility-security": [
